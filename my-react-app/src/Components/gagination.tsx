...
import { nextPageAction, previousPageAction } from "../store/reducers/current-pages-reducer";
...
export function Pagination() {
    ...
    const amountPages = useSelector(state => state.amountPagesReducer.amount_pages)
    ...
    return(
      <div className="pagination">
        <div className="pagination__buttons">
          ...
          <button disabled={currentPage === amountPages}className="forvard-pagination" onClick={() => nextPage() }>Вперед</button>
        </div>
